        ...
        <div className="grid gap-8 lg:grid-cols-3">
              ...
              <div className="space-y-6">
                ...
                <div className="rounded-xl border border-border bg-surface p-6">
                  ...
                  <div className="mb-4 h-3 overflow-hidden rounded-full bg-border">
                    <div className="h-full rounded-full bg-gradient-to-r from-primary to-primary-light" style={{ width: `${p.funding}%` }} />
                  </div>
                ...
                <div className="rounded-xl border border-border bg-surface p-6">
                  ...
                  <div className="flex h-48 items-end gap-2">
                    {[35, 42, 38, 51, 47, 44, 39, 45, 48, 52, 41, 46].map((v, i) => (
                      <div key={i} className="chart-bar flex-1 rounded-t bg-gradient-to-t from-primary to-primary-light" style={{ height: `${(v / 60) * 100}%` }} />
                    ))}
                  </div>
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24 rounded-2xl border border-border bg-surface p-6 shadow-lg">
              ...
              <div className="mb-4">
                <label className="mb-1.5 block text-sm font-medium text-foreground">Cantidad de tokens</label>
                <input
                  type="number"
                  min="1"
              ...
              <div className="text-center text-xs text-muted">Transacción firmada con Freighter</div>
            </div>
          </div>
        </div>
      </main>
